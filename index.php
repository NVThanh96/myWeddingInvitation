...
<head>
    ...
    <title>Thiệp cưới Thành & Luy Online</title>
    ...
    <meta name="title" content="Thiệp cưới Thành & Luyến Online">
    <meta name="description" content="Thiệp cưới Thành & Luyến Online">
    ...
    <meta property="og:title" content="Thiệp cưới Thành & Luyến Online">
    <meta property="og:description" content="Thiệp cưới Thành & Luyến Online">
    ...
    <meta property="og:image:alt" content="Thiệp cưới Thành & Luyến Online">
    <meta property="og:type" content="website">
    <meta property="og:locale" content="id_ID">
    <meta property="og:url" content="https://ulems.my.id">
    <meta property="og:site_name" content="Thiệp cưới Thành & Luyến Online">

    <!-- Appearance -->
    <meta name="mobile-web-app-capable" content="yes">
    <meta name="apple-mobile-web-app-title" content="Thiệp cưới Thành & Luyến Online">
    ...
    <link href="https://fonts.googleapis.com/css2?family=Alfa+Slab+One&family=Protest+Guerrilla&family=Tapestry&display=swap" rel="stylesheet">
    <link href="https://fonts.googleapis.com/css2?family=Alfa+Slab+One&family=Explora&family=Protest+Guerrilla&family=Tapestry&display=swap" rel="stylesheet">
...
<body data-email="user@example.com" data-password="12345678" data-url="https://api.ulems.my.id/" style="overflow-y: hidden;">
    ...
    <?php include('../wedding-invitation/template/navbottom.php')?>

    <svg xmlns="https://www.w3.org/2000/svg" viewBox="0 0 1440 180" style="transform: rotate(180deg);">
    ...
    <?php include('../wedding-invitation/template/main-content.php')?>
   

        <!-- Wave Separator -->
        <svg xmlns="https://www.w3.org/2000/svg" viewBox="0 0 1440 180">
            ...
            <div class="text-center">
                ...
                <div class="overflow-x-hidden">
                    ...
                    <div data-aos="fade-right" data-aos-duration="2000">
                        ...
                        <h1 class="protest-guerrilla-regular" style="font-size: 3rem;">Nguyễn Văn Thành</h1>
                        <p class="mt-3 mb-0" style="font-size: 1.25rem;">Thứ Nam</p>
                        <p class="mb-0">Bính Tý</p>
                    </div>
                    ...
                    <div data-aos="fade-left" data-aos-duration="2000">
                        ...
                        <h1 class="protest-guerrilla-regular" style="font-size: 3rem;">Phạm Thị Mai Luyến</h1>
                        <p class="mt-3 mb-0" style="font-size: 1.25rem;">Thứ Nữ</p>
                        <p class="mb-0">Bính Tý</p>
                    </div>
                </div>
    ...
    <div class="loading-page" id="welcome" style="opacity: 1;">
        <div class="d-flex justify-content-center align-items-center" style="height: 100vh !important;">
            ...
            <div class="text-center">
                ...
                <h1 class="font-esthetic my-4" style="font-size: 2.5rem;">Văn Thành & Mai Luyến</h1>
                <div id="nama-tamu"></div>

                <button type="button" class="btn btn-light shadow rounded-4 mt-4" onclick="util.buka(this)">
                    <i class="fa-solid fa-envelope-open me-2"></i>Xem Thiệp
                </button>
            </div>
        </div>
    </div>
            ...
            <div class="modal-content">
                <div class="modal-body p-0">
                    <div class="d-flex justify-content-center align-items-center" style="height: 100%;">
                        <img src="./assets/images/bg.jpeg" class="w-50" alt="foto" id="show-modal-image">
                    </div>
                </div>
            </div>
        </div>
