...
<head>
    ...
    <title>Thiệp cưới Thành & Luyến Online</title>
    ...
    <link rel="shortcut icon" type="image/x-icon" href="../myWeddingInvitation/assets/images/icon.png">
    <link rel="apple-touch-icon" sizes="192x192" type="image/png" href="https://ulems.my.id/assets/images/icon-192x192.png">
    <link rel="icon" type="image/x-icon" href="../myWeddingInvitation/assets/images/icon.png">
